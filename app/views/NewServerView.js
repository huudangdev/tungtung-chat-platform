...
import {
	Text, ScrollView, Keyboard, Image, StyleSheet, TouchableOpacity, View, Alert, ImageBackground
} from 'react-native';
...
const defaultServer = 'https://tungtung.rocket.chat';
...
class NewServerView extends React.Component {
	...
	render() {
		...
		return (
			<ImageBackground
      source={require('../static/images/blur.png')}
			...
			>
				...
				<ScrollView {...scrollPersistTaps} contentContainerStyle={sharedStyles.containerScrollView}>
					<SafeAreaView style={sharedStyles.container} testID='new-server-view'>
						<Image style={styles.image} source={require('../static/images/logo.png')} />
						<Text style={[styles.title, { color: themes[theme].titleText }]}>Auto Login to Server</Text>
