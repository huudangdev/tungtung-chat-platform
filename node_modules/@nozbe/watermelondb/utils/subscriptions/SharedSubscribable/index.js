...
function () {
  ...
  _proto.subscribe = function subscribe(subscriber) {
    ...
    if (1 === this._subscribers.length) {
      this._isSubscribed = true; // TODO: What if this throws?
    ...
    return function () {
      return _this._unsubscribe(subscriber);
    };
  };

  _proto._notify = function _notify(value) {
    (0, _invariant.default)(this._isSubscribed, "SharedSubscribable's source emitted a value after it was unsubscribed from");
    this._didEmit = true;
  ...
  _proto._unsubscribe = function _unsubscribe(subscriber) {
