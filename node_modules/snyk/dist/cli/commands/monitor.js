...
function monitor(...args0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (options['experimental-dep-graph']) {
            const isFFSupported = yield isFeatureFlagSupportedForOrg(_.camelCase('experimental-dep-graph'));
            if (!isFFSupported.ok) {
        ...
        for (const path of args) {
            try {
                ...
                for (const depRootDeps of perDepRootResults) {
                    print_deps_1.maybePrintDeps(options, depRootDeps.package);
                    ...
                    const subProjectName = types_1.isMultiResult(inspectResult)
