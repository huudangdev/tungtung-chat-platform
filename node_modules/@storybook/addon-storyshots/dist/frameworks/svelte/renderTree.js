...
function getRenderedTree(story) {
  ...
  const DefaultCompatComponent = Component.default || Component; // We need to create a target to mount onto.

  const target = _global.document.createElement('section');

  new DefaultCompatComponent({
    target,
    props
  }); // eslint-disable-line
